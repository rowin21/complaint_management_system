...
$sql = "select email,password,first_name,last_name from userdata where email='$user' and password='$pass';";
...
if(isset($_POST['login'])){
    ...
    if($value['email'] == $user && $value['password'] == $pass){
        ...
        <div id='card' class="animated fadeIn">
            <div id='upper-side1'>
                <img src="assets/wrong.png" alt="tick" width="100px" height="100px">
